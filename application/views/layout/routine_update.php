<div id="activelicmodal" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?php echo site_url('admin/admin/updatePurchaseCode') ?>" method="POST" >
                <div class="modal-body lic_modal-body">
                    ...
                    <div class="form-group">
                        <label class="ainline"><span>Purchase Code for Smart School.<a  href="<?= base_url()?>/admin/licence"> Get it</a> </span></label>
