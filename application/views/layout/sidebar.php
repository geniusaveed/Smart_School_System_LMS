...
if ($this->rbac->hasPrivilege('general_setting', 'can_view')) {
        ...
        if ($this->rbac->hasPrivilege('superadmin')) {
            ?>
                               ...
                               <li class="<?php echo set_Submenu('System Settings/updater'); ?>"><a target="_blank" href="https://2gd15z4cpsukl0gxnmoqwa-on.drv.tw/SMARTSCHOOLDOC/"><i class="fa fa-angle-double-right"></i> <?php echo 'User Guide'?></a></li>
                        <?php
}
